...
from .routers import apps, apt, auth, catalog, discovery, docker, dockerhub, health, install_auth, metrics, settings as settings_router, storage, system
...
app.include_router(apt.router)
app.include_router(install_auth.router)
